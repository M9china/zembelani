...
export const About = () => {
  return (
    <main
      ...
      className="bg-white min-h-screen pt-6 block sm:hidden"
    >
      <p className="text-gray-600 px-4 font-sans text-md justify-items-center">
        {AboutUs.wwa}
      </p>
      <h1 className="text-[#001A4B] px-4 font-semibold text-3xl mt-8">WHAT WE DO</h1>
